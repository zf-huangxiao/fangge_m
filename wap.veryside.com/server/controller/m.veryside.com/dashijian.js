...
var controlFns = {
    ...
    content : function(arg){
        ...
        this.listenOver(function(data){
            ...
            data._CSSLinks = ['h5/css/dashijian'];
            data._JSLinks  = ['h5/min/dashijian'];
            data.pageTitle = '街拍';
            mSelf.render('dashijian/index.html', data);
        });
    },
    ...
    index_apis: function(params){
        var php = {
            'indexloadlist' : 'store::/news/channel?id=4',
...
exports.__create = controller.__create(dashijian , controlFns);
