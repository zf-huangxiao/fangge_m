...
var controlFns = {
    ...
    content : function(arg){
        ...
        var php = {
            'indexlist' : 'store::/news/channel?id=3',
        ...
        this.listenOver(function(data){
            ...
            data.status = 'shenghuo';

            data._CSSLinks = ['h5/css/shenghuo'];
            data._JSLinks  = ['h5/min/shenghuo'];
            data.pageTitle = '生活';
            mSelf.render('shenghuo/index.html', data);
        });
    },
    ...
    index_apis: function(params){
        var php = {
            'indexloadlist' : 'store::/news/channel?id=3',
...
exports.__create = controller.__create(shenghuo , controlFns);
